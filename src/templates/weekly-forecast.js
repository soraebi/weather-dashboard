    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <div v-for="day in state.weeklyForecast" :key="day.dayName"
                ...
                <div class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">{{ day.dayName }}</div>
                <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">{{ day.formattedDate }}</div>
